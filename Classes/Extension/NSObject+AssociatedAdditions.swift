...
internal extension NSObject {
    ...
    public func value<Value>(forAssociationKey key: AssociationKey<Value>) -> Value {
    ...
    /// - returns: The associated value, or the default value if no value has been
    ///            associated with the key.
    public func value(forKeyString key: StaticString) -> Any? {
    ...
    /// - returns: The associated value, or `nil` if no value is associated with
    ///            the key.
    public func value(forKeyString key: StaticString, defaultValue: () -> Any?) -> Any? {
    ...
    ///   - key: The key.
    public func setValue<Value>(_ value: Value, forAssociationKey key: AssociationKey<Value>) {
    ...
    ///   - value: The value to be associated.
    ///   - key: The key string.
    public func setValue<Value>(_ value: Value, forKeyString key: StaticString) {
        willChangeValue(forKey: "self")
